		...
		for (i = 0; i < OSTOPOKOPURUA; i++){
			...
			if (ostopoak[i].kolorea == HARRI_KOLOREA){
				while (ondo == 0){
					...
					if ((ostopoak[i].y1 - ERRADIOBOLA - 1 == posizioGorria.y) && ((ostopoak[i].x0 == posizioGorria.x + ERRADIOBOLA) || (ostopoak[i].x0 == posizioGorria.x + ERRADIOBOLA+1) || (ostopoak[i].x0 == posizioGorria.x + ERRADIOBOLA+2) || (ostopoak[i].x0 == posizioGorria.x + ERRADIOBOLA+3)) && (jarraitu == 1)){
