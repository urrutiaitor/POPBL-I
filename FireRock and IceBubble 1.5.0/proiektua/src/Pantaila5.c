...
int PANTAILA5_nagusia(){ //hau egin behar da bolaren mugimenduak eta pantaila eta ... lotzeko, nagusia.c -tik dator ona
	...
	ERREALITATE_FISIKOA_mugimendua(posizioGorria, posizioUrdina, 6);
...
void PANTAILA5_pantailaMargotu(){
	...
	//botoia
	JOKOA_laukiBatMargotu(595, 340, 615, 350, MOREA);

	//plataforma mugikorra
	JOKOA_laukiBatMargotu(320, 100, 400, 115, MOREA);
	...
	//plataforma mugikorra
	JOKOA_laukiBatMargotu(200, 335, 280, 350, MOREA);
