...
void ERREALITATE_FISIKOA_mugimendua(POSIZIOA posizioGorria, POSIZIOA posizioUrdina, int pantaila){
	...
	do{
		...
		//talkak berdearekin
		if ((bolaGorriaTalkaPuntuak[0].talkaPuntua == BERDE_ILUNA) && (bolaGorriaTalkaPuntuak[0].talkaPuntua == HARRI_KOLOREA)){
			posizioGorria.inertziaY = -(2*(posizioGorria.inertziaY/3));
		}
		if ((bolaGorriaTalkaPuntuak[3].talkaPuntua == BERDE_ILUNA) && (bolaGorriaTalkaPuntuak[3].talkaPuntua == HARRI_KOLOREA)){
			posizioGorria.inertziaX = +(posizioGorria.inertziaY / 2);
			posizioGorria.inertziaY = -(posizioGorria.inertziaY / 4);
		}
		if ((bolaGorriaTalkaPuntuak[1].talkaPuntua == BERDE_ILUNA) && (bolaGorriaTalkaPuntuak[1].talkaPuntua == HARRI_KOLOREA)){
			posizioGorria.inertziaX = +(posizioGorria.inertziaY / 4);
			posizioGorria.inertziaY = -(posizioGorria.inertziaY / 2);
		}
		if ((bolaGorriaTalkaPuntuak[2].talkaPuntua == BERDE_ILUNA) && (bolaGorriaTalkaPuntuak[2].talkaPuntua == HARRI_KOLOREA)){
			posizioGorria.inertziaX = -(posizioGorria.inertziaY / 4);
			posizioGorria.inertziaY = -(posizioGorria.inertziaY / 2);
		}
		if ((bolaGorriaTalkaPuntuak[4].talkaPuntua == BERDE_ILUNA) && (bolaGorriaTalkaPuntuak[4].talkaPuntua == HARRI_KOLOREA)){
			posizioGorria.inertziaX = -(posizioGorria.inertziaY / 2);
			posizioGorria.inertziaY = -(posizioGorria.inertziaY / 4);
		}

		if ((bolaGorriaTalkaPuntuak[11].talkaPuntua == BERDE_ILUNA) && (bolaGorriaTalkaPuntuak[11].talkaPuntua == HARRI_KOLOREA)){
			posizioGorria.inertziaY = -(2 * (posizioGorria.inertziaY / 3));
		}
		if ((bolaGorriaTalkaPuntuak[8].talkaPuntua == BERDE_ILUNA) && (bolaGorriaTalkaPuntuak[8].talkaPuntua == HARRI_KOLOREA)){
			posizioGorria.inertziaX = +(posizioGorria.inertziaY / 2);
			posizioGorria.inertziaY = -(posizioGorria.inertziaY / 4);
		}
		if ((bolaGorriaTalkaPuntuak[10].talkaPuntua == BERDE_ILUNA) && (bolaGorriaTalkaPuntuak[10].talkaPuntua == HARRI_KOLOREA)){
			posizioGorria.inertziaX = +(posizioGorria.inertziaY / 4);
			posizioGorria.inertziaY = -(posizioGorria.inertziaY / 2);
		}
		if ((bolaGorriaTalkaPuntuak[9].talkaPuntua == BERDE_ILUNA) && (bolaGorriaTalkaPuntuak[9].talkaPuntua == HARRI_KOLOREA)){
			posizioGorria.inertziaX = -(posizioGorria.inertziaY / 4);
			posizioGorria.inertziaY = -(posizioGorria.inertziaY / 2);
		}
		if ((bolaGorriaTalkaPuntuak[7].talkaPuntua == BERDE_ILUNA) && (bolaGorriaTalkaPuntuak[7].talkaPuntua == HARRI_KOLOREA)){
			posizioGorria.inertziaX = -(posizioGorria.inertziaY / 2);
			posizioGorria.inertziaY = -(posizioGorria.inertziaY / 4);
		}
		if ((bolaGorriaTalkaPuntuak[5].talkaPuntua == BERDE_ILUNA) && (bolaGorriaTalkaPuntuak[5].talkaPuntua == HARRI_KOLOREA)){
			posizioGorria.inertziaX = -(posizioGorria.inertziaX / 3);
		}
		if ((bolaGorriaTalkaPuntuak[6].talkaPuntua == BERDE_ILUNA) && (bolaGorriaTalkaPuntuak[6].talkaPuntua == HARRI_KOLOREA)){
			posizioGorria.inertziaX = -(posizioGorria.inertziaX / 3);
		}


		if ((bolaUrdinaTalkaPuntuak[0].talkaPuntua == BERDE_ILUNA) && (bolaUrdinaTalkaPuntuak[0].talkaPuntua == HARRI_KOLOREA)){
			posizioUrdina.inertziaY = -(2 * (posizioUrdina.inertziaY / 3));
		}
		if ((bolaUrdinaTalkaPuntuak[3].talkaPuntua == BERDE_ILUNA) && (bolaUrdinaTalkaPuntuak[3].talkaPuntua == HARRI_KOLOREA)){
			posizioUrdina.inertziaX = +(posizioUrdina.inertziaY / 2);
			posizioUrdina.inertziaY = -(posizioUrdina.inertziaY / 4);
		}
		if ((bolaUrdinaTalkaPuntuak[1].talkaPuntua == BERDE_ILUNA) && (bolaUrdinaTalkaPuntuak[1].talkaPuntua == HARRI_KOLOREA)){
			posizioUrdina.inertziaX = +(posizioUrdina.inertziaY / 4);
			posizioUrdina.inertziaY = -(posizioUrdina.inertziaY / 2);
		}
		if ((bolaUrdinaTalkaPuntuak[2].talkaPuntua == BERDE_ILUNA) && (bolaUrdinaTalkaPuntuak[2].talkaPuntua == HARRI_KOLOREA)){
			posizioUrdina.inertziaX = -(posizioUrdina.inertziaY / 4);
			posizioUrdina.inertziaY = -(posizioUrdina.inertziaY / 2);
		}
		if ((bolaUrdinaTalkaPuntuak[4].talkaPuntua == BERDE_ILUNA) && (bolaUrdinaTalkaPuntuak[4].talkaPuntua == HARRI_KOLOREA)){
			posizioUrdina.inertziaX = -(posizioUrdina.inertziaY / 2);
			posizioUrdina.inertziaY = -(posizioUrdina.inertziaY / 4);
		}

		if ((bolaUrdinaTalkaPuntuak[11].talkaPuntua == BERDE_ILUNA) && (bolaUrdinaTalkaPuntuak[11].talkaPuntua == HARRI_KOLOREA)){
			posizioUrdina.inertziaY = -(2 * (posizioUrdina.inertziaY / 3));
		}
		if ((bolaUrdinaTalkaPuntuak[8].talkaPuntua == BERDE_ILUNA) && (bolaUrdinaTalkaPuntuak[8].talkaPuntua == HARRI_KOLOREA)){
			posizioUrdina.inertziaX = +(posizioUrdina.inertziaY / 2);
			posizioUrdina.inertziaY = -(posizioUrdina.inertziaY / 4);
		}
		if ((bolaUrdinaTalkaPuntuak[10].talkaPuntua == BERDE_ILUNA) && (bolaUrdinaTalkaPuntuak[10].talkaPuntua == HARRI_KOLOREA)){
			posizioUrdina.inertziaX = +(posizioUrdina.inertziaY / 4);
			posizioUrdina.inertziaY = -(posizioUrdina.inertziaY / 2);
		}
		if ((bolaUrdinaTalkaPuntuak[9].talkaPuntua == BERDE_ILUNA) && (bolaUrdinaTalkaPuntuak[9].talkaPuntua == HARRI_KOLOREA)){
			posizioUrdina.inertziaX = -(posizioUrdina.inertziaY / 4);
			posizioUrdina.inertziaY = -(posizioUrdina.inertziaY / 2);
		}
		if ((bolaUrdinaTalkaPuntuak[7].talkaPuntua == BERDE_ILUNA) && (bolaUrdinaTalkaPuntuak[7].talkaPuntua == HARRI_KOLOREA)){
			posizioUrdina.inertziaX = -(posizioUrdina.inertziaY / 2);
			posizioUrdina.inertziaY = -(posizioUrdina.inertziaY / 4);
		}
		if ((bolaUrdinaTalkaPuntuak[5].talkaPuntua == BERDE_ILUNA) && (bolaUrdinaTalkaPuntuak[5].talkaPuntua == HARRI_KOLOREA)){
			posizioUrdina.inertziaX = -(posizioUrdina.inertziaX / 3);
		}
		if ((bolaUrdinaTalkaPuntuak[6].talkaPuntua == BERDE_ILUNA) && (bolaUrdinaTalkaPuntuak[6].talkaPuntua == HARRI_KOLOREA)){
			posizioUrdina.inertziaX = -(posizioUrdina.inertziaX / 3);
		}		
		...
		if ((controls.keyboard.Uarrow == TRUE) && (posizioGorria.inertziaY == 0) && ((bolaGorriaTalkaPuntuak[0].talkaPuntua == BERDE_ILUNA) || (bolaGorriaTalkaPuntuak[0].talkaPuntua == HARRI_KOLOREA))){
			posizioGorria.inertziaY = -5;
		}

		//eskuma

		if ((controls.keyboard.Rarrow == TRUE) && ((bolaGorriaTalkaPuntuak[6].talkaPuntua != BERDE_ILUNA) || (bolaGorriaTalkaPuntuak[6].talkaPuntua != HARRI_KOLOREA))){
			posizioGorria.inertziaX = posizioGorria.inertziaX + 3;
		}

		//ezkerra

		if ((controls.keyboard.Larrow == TRUE) && ((bolaGorriaTalkaPuntuak[5].talkaPuntua != BERDE_ILUNA) || (bolaGorriaTalkaPuntuak[5].talkaPuntua != HARRI_KOLOREA))){
			posizioGorria.inertziaX = posizioGorria.inertziaX - 3;
		}
		...
		if ((controls.keyboard.w == TRUE) && (posizioUrdina.inertziaY == 0) && ((bolaUrdinaTalkaPuntuak[0].talkaPuntua == BERDE_ILUNA) || (bolaUrdinaTalkaPuntuak[0].talkaPuntua == HARRI_KOLOREA))){
			posizioUrdina.inertziaY = -5;
		}

		//eskuma

		if ((controls.keyboard.d == TRUE) && ((bolaUrdinaTalkaPuntuak[6].talkaPuntua != BERDE_ILUNA) || (bolaUrdinaTalkaPuntuak[6].talkaPuntua != HARRI_KOLOREA))){
			posizioUrdina.inertziaX = posizioUrdina.inertziaX + 3;
		}

		//ezkerra

		if ((controls.keyboard.a == TRUE) && ((bolaUrdinaTalkaPuntuak[5].talkaPuntua != BERDE_ILUNA) || (bolaUrdinaTalkaPuntuak[5].talkaPuntua != HARRI_KOLOREA))){
			posizioUrdina.inertziaX = posizioUrdina.inertziaX - 3;
		}
