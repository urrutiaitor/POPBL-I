...
void ERREALITATE_FISIKOA_mugimendua(POSIZIOA posizioGorria, POSIZIOA posizioUrdina, int pantaila){
	...
	do{
		...
		if (bolaGorriaTalkaPuntuak[0].talkaPuntua == ZURIA){
			posizioGorria.inertziaY = -(2*(posizioGorria.inertziaY/3));
		}
		if (bolaGorriaTalkaPuntuak[3].talkaPuntua == ZURIA){
			posizioGorria.inertziaX = +(posizioGorria.inertziaY / 2);
			posizioGorria.inertziaY = -(posizioGorria.inertziaY / 4);
		}
		if (bolaGorriaTalkaPuntuak[1].talkaPuntua == ZURIA){
			posizioGorria.inertziaX = +(posizioGorria.inertziaY / 4);
			posizioGorria.inertziaY = -(posizioGorria.inertziaY / 2);
		}
		if (bolaGorriaTalkaPuntuak[2].talkaPuntua == ZURIA){
			posizioGorria.inertziaX = -(posizioGorria.inertziaY / 4);
			posizioGorria.inertziaY = -(posizioGorria.inertziaY / 2);
		}
		if (bolaGorriaTalkaPuntuak[4].talkaPuntua == ZURIA){
			posizioGorria.inertziaX = -(posizioGorria.inertziaY / 2);
			posizioGorria.inertziaY = -(posizioGorria.inertziaY / 4);
		}

		if (bolaGorriaTalkaPuntuak[11].talkaPuntua == ZURIA){
			posizioGorria.inertziaY = -(2 * (posizioGorria.inertziaY / 3));
		}
		if (bolaGorriaTalkaPuntuak[8].talkaPuntua == ZURIA){
			posizioGorria.inertziaX = +(posizioGorria.inertziaY / 2);
			posizioGorria.inertziaY = -(posizioGorria.inertziaY / 4);
		}
		if (bolaGorriaTalkaPuntuak[10].talkaPuntua == ZURIA){
			posizioGorria.inertziaX = +(posizioGorria.inertziaY / 4);
			posizioGorria.inertziaY = -(posizioGorria.inertziaY / 2);
		}
		if (bolaGorriaTalkaPuntuak[9].talkaPuntua == ZURIA){
			posizioGorria.inertziaX = -(posizioGorria.inertziaY / 4);
			posizioGorria.inertziaY = -(posizioGorria.inertziaY / 2);
		}
		if (bolaGorriaTalkaPuntuak[7].talkaPuntua == ZURIA){
			posizioGorria.inertziaX = -(posizioGorria.inertziaY / 2);
			posizioGorria.inertziaY = -(posizioGorria.inertziaY / 4);
		}
		if (bolaGorriaTalkaPuntuak[5].talkaPuntua == ZURIA){
			posizioGorria.inertziaX = -(posizioGorria.inertziaX / 3);
		}
		if (bolaGorriaTalkaPuntuak[6].talkaPuntua == ZURIA){
			posizioGorria.inertziaX = -(posizioGorria.inertziaX / 3);
		}
		...
		if (controls.keyboard.d == TRUE){
			posizioUrdina.x = posizioUrdina.x + 2;
		}
...
TALKAPOSIZIOA ERREALITATE_FISIKOA_talkakKonprobatu(POSIZIOA posizio){
	//aldagaiak
	int zutabea = 0, ilara = 0;
	int i = 0;

	TALKAPOSIZIOA bolaTalkaPuntuak[12];
	TALKAPOSIZIOA bolaTalkaPuntua;


	//programa
	bolaTalkaPuntua.talkaPuntua = 0;
	bolaTalkaPuntua.x = 0;
	bolaTalkaPuntua.y = 0;
