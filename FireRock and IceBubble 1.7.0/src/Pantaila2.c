...
void PANTAILA2_pantailaMargotu3D(){
	...
	//erdiko plataforma
	//erdikoa
	JOKOA_laukiBatMargotu3D(320, 200, 550, 230, BERDE_ILUNA);
	//ezkerrekoa
	JOKOA_laukiBatMargotu3D(0, 280, 330, 310, BERDE_ILUNA);
	//eskuinekoa
	JOKOA_laukiBatMargotu3D(410, 280, 640, 310, BERDE_ILUNA);

	//goiko plataforma
	JOKOA_laukiBatMargotu3D(0, 120, 290, 150, BERDE_ILUNA);
