...
void PANTAILA0_pantailaMargotu3D(){
	...
	//beheko lerroa
	JOKOA_laukiBatMargotu3D(0, 470, 640, 480, BERDE_ILUNA);
	...
	//eskumako lerroa
	JOKOA_laukiBatMargotu3D(629, 0, 640, 480, BERDE_ILUNA);



	//1.eskaloia
	JOKOA_laukiBatMargotu3D(149, 430, 349, 470, BERDE_ILUNA);


	//2.eskaloia
	JOKOA_laukiBatMargotu3D(199, 390, 299, 430, BERDE_ILUNA);


	//3.eskaloia
	JOKOA_laukiBatMargotu3D(399, 369, 499, 399, BERDE_ILUNA);
