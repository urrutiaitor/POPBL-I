...
void PANTAILA1_pantailaMargotu3D(){
	...
	//erdiko plataforma
	JOKOA_laukiBatMargotu3D(0, 320, 510, 350, BERDE_ILUNA);


	//goiko plataforma
	JOKOA_laukiBatMargotu3D(250, 210, 640, 240, BERDE_ILUNA);


	//putzuak
	//gorria
	JOKOA_laukiBatMargotu3D(160, 450, 260, 460, GORRIA);

	//urdina
	JOKOA_laukiBatMargotu3D(330, 450, 430, 460, URDINA);

	//berdea
	JOKOA_laukiBatMargotu3D(300, 210, 400, 220, BERDEA);
