...
void PANTAILA4_pantailaMargotu3D(){
	...
	//erdiko plataformak 
	//ezkerrekoa
	JOKOA_laukiBatMargotu3D(0, 160, 250, 180, BERDE_ILUNA);
	//eskuinekoa
	JOKOA_laukiBatMargotu3D(350, 180, 640, 210, BERDE_ILUNA);
	//erdikoa
	JOKOA_laukiBatMargotu3D(200, 300, 500, 330, BERDE_ILUNA);

	//goiko plataforma
	//ezkerrekoa
	JOKOA_laukiBatMargotu3D(0, 100, 180, 130, BERDE_ILUNA);
	//eskuinekoa
	JOKOA_laukiBatMargotu3D(400, 100, 640, 130, BERDE_ILUNA);

	//putzuak
	//gorria
	JOKOA_laukiBatMargotu3D(450, 100, 510, 110, GORRIA);

	//urdina
	JOKOA_laukiBatMargotu3D(230, 450, 430, 460, URDINA);

	//berdea
	JOKOA_laukiBatMargotu3D(360, 300, 400, 310, BERDEA);
	//harria
	...
	//pelota
	JOKOA_laukiBatMargotu3D(ostopoak[5].x0, ostopoak[5].y0, ostopoak[5].x1, ostopoak[5].y1, ostopoak[5].kolorea);
	...
	//pelota
	JOKOA_laukiBatMargotu3D(ostopoak[6].x0, ostopoak[6].y0, ostopoak[6].x1, ostopoak[6].y1, ostopoak[6].kolorea);
