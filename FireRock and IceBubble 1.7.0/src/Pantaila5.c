...
void PANTAILA5_pantailaMargotu3D(){
	...
	//erdiko plataformak 
	//ezkerrekoa
	JOKOA_laukiBatMargotu3D(0, 360, 110, 390, BERDE_ILUNA);
	//eskuinekoa
	JOKOA_laukiBatMargotu3D(550, 360, 640, 390, BERDE_ILUNA);
	//erdikoa
	JOKOA_laukiBatMargotu3D(230, 350, 450, 380, BERDE_ILUNA);

	//goiko plataforma
	//ezkerrekoa
	JOKOA_laukiBatMargotu3D(0, 100, 230, 130, BERDE_ILUNA);
	//eskuinekoa
	JOKOA_laukiBatMargotu3D(400, 200, 640, 230, BERDE_ILUNA);

	//putzuak
	//gorria
	JOKOA_laukiBatMargotu3D(440, 200, 540, 210, GORRIA);

	//urdina
	JOKOA_laukiBatMargotu3D(110, 100, 160, 110, URDINA);
