...
void PANTAILA2_nagusia(){ //hau egin behar da bolaren mugimenduak eta pantaila eta ... lotzeko, nagusia.c -tik dator ona
	...
	do{
		...
		//diamanteak
		//gorria
		ostopoak[5].kolorea = DIAMANTE_GORRIA;
		ostopoak[5].x0 = 590;
		ostopoak[5].y0 = 260;
		ostopoak[5].x1 = 0;
		ostopoak[5].y1 = 0;
		...
		//urdina
		ostopoak[6].kolorea = DIAMANTE_URDINA;
		ostopoak[6].x0 = 300;
		ostopoak[6].y0 = 430;
		ostopoak[6].x1 = 0;
		ostopoak[6].y1 = 0;
...
//diamanteak
	//gorria
	JOKOA_diamanteBatMargotu(ostopoak[5].x0, ostopoak[5].y0, ostopoak[5].kolorea);
	//urdina
	JOKOA_diamanteBatMargotu(ostopoak[6].x0, ostopoak[6].y0, ostopoak[6].kolorea);
...
void PANTAILA2_pantailaMargotu3D(){
	//aldagaiak
	int x = 0, y = 0;
	...
	//erdiko plataforma
	//erdikoa
	JOKOA_laukiBatMargotu3D(320, 200, 550, 230, BLOKEA_FONDO);
	//ezkerrekoa
	JOKOA_laukiBatMargotu3D(0, 280, 330, 310, BLOKEA_FONDO);
	//eskuinekoa
	JOKOA_laukiBatMargotu3D(410, 280, 640, 310, BLOKEA_FONDO);
	//goiko plataforma
	JOKOA_laukiBatMargotu3D(0, 120, 290, 150, BLOKEA_FONDO);


	//putzuak
	//gorria
	JOKOA_laukiBatMargotu3D(ostopoak[0].x0, ostopoak[0].y0, ostopoak[0].x1, ostopoak[0].y1, GORRIA_FONDO);

	//urdina
	JOKOA_laukiBatMargotu3D(ostopoak[1].x0, ostopoak[1].y0, ostopoak[1].x1, ostopoak[1].y1, URDINA_FONDO);

	//berdea
	JOKOA_laukiBatMargotu3D(ostopoak[2].x0, ostopoak[2].y0, ostopoak[2].x1, ostopoak[2].y1, BERDEA_FONDO);
	...
	//plataforma mugikorra
	//botoia
	JOKOA_laukiBatMargotu3D(ostopoak[3].x0, ostopoak[3].y0, ostopoak[3].x1, ostopoak[3].y1, GRIS2);

	//plataforma mugikorra
	JOKOA_laukiBatMargotu3D(ostopoak[4].x0, ostopoak[4].y0, ostopoak[4].x1, ostopoak[4].y1, GRIS2);
}
