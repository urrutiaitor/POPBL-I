...
void PANTAILA5_pantailaMargotu(){
	...
	//urdina
	JOKOA_laukiBatMargotu(110, 100, 160, 110, URDINA);
...
void PANTAILA5_pantailaMargotu3D(){
	//aldagaiak
	int x = 0, y = 0;
	...
	//erdiko plataformak 
	//ezkerrekoa
	JOKOA_laukiBatMargotu3D(0, 360, 110, 390, BLOKEA_FONDO);
	//eskuinekoa
	JOKOA_laukiBatMargotu3D(550, 360, 640, 390, BLOKEA_FONDO);
	//erdikoa
	JOKOA_laukiBatMargotu3D(230, 350, 450, 380, BLOKEA_FONDO);

	//goiko plataforma
	//ezkerrekoa
	JOKOA_laukiBatMargotu3D(0, 100, 230, 130, BLOKEA_FONDO);
	//eskuinekoa
	JOKOA_laukiBatMargotu3D(400, 200, 640, 230, BLOKEA_FONDO);

	//putzuak
	//gorria
	JOKOA_laukiBatMargotu3D(440, 200, 540, 210, GORRIA_FONDO);

	//urdina
	JOKOA_laukiBatMargotu3D(110, 100, 160, 110, URDINA_FONDO);
